...
![control freak]({{ site.baseurl }}/images/high_utility_products/control_freak.avif "Breville Control Freak"){: .img-80}
...
## Mini offset spatula -- [$6](https://www.amazon.com/Ateco-1385-Spatula-4-5-Inch-Stainless/dp/B000WG14FC/ref=sr_1_2)
![offset]({{ site.baseurl }}/images/high_utility_products/offset.jpg "Offset spatula"){: .img-60 }
...
## Good kitchen scale -- [around $55](https://www.amazon.com/OXO-Grips-Stainless-Pull-Out-Display/dp/B079D9B82W)
![oxo]({{ site.baseurl }}/images/high_utility_products/oxo.jpg "OXO scale"){: .img-50}
...
## Induction stove or range -- varies, mine was [$4000](https://www.yaleappliance.com/product/beko-30-stainless-steel-pro-style-induction-range-prir34452ss-1152629)
![beko range]({{ site.baseurl }}/images/high_utility_products/beko.webp "Beko induction range"){: .img-50}

Induction vs. gas stoves has become a culture war topic in the US, which is unfortunate. The health risks of gas stoves are probably [modest but not zero](https://dynomight.net/stoves/), and climate impacts are probably from mostly second order effects like methane leaks. But the climate-and-health culture war has missed the key point about induction stoves, which is that they are the best kind of stove to live with because they are _the easiest to clean_.
...
# Tech
## Trackball mouse -- [$50](https://www.logitech.com/en-us/products/mice/m575-ergo-wireless-trackball.910-005867.html)
![Logitech trackball]( {{ site.baseurl }}/images/high_utility_products/mouse.webp "Trackball mouse"){: .img-60}
